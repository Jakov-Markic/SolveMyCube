...
String solveBottomCross(RubiksCube cube) {
  ...
  for (int i = 0; i < 4; i++) {
    ...
    else if (matchEdge(cube, Face.D, 0, 1, Face.F, 2, 1, cD, cF)) bringToTop = "F2"; // Flipped at target position
    else if (matchEdge(cube, Face.D, 1, 2, Face.R, 2, 1, cD, cF)) bringToTop = "R2";
    else if (matchEdge(cube, Face.D, 2, 1, Face.B, 2, 1, cD, cF)) bringToTop = "B2";
    else if (matchEdge(cube, Face.D, 1, 0, Face.L, 2, 1, cD, cF)) bringToTop = "L2";
    ...
    else if (matchEdge(cube, Face.U, 0, 1, Face.B, 0, 1, cD, cF)) alignTop = "U2";
